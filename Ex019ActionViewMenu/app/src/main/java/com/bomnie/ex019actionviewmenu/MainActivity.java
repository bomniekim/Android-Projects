package com.bomnie.ex019actionviewmenu;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //ActionView 안에 있는 EditText 찾아오기 (3단계 거치기ㅠ..)
        ...
        //EditText 의 소프트키보드에 있는 돋보기 버튼( :imeOptions="actionSearch" )을 클릭하는 것을
        //듣는 리스너 객체 생성 및 추가
    ...
    public void clickBtn(View view) {
        //기존에 있는 액션 바를 덮어버리는 ActionMode

        //액션모드 시작하기 : 액션바 위치에 메뉴가 보여짐
        startActionMode(new ActionMode.Callback() {
            @Override
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) { // 처음 한 번 실행했을 때
                ...
                return true; //true가 아니면 ActionMode가 발동하지 않음
            }
