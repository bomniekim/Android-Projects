package com.bomnie.ex036xmlpullparsermovie;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View view) {
        //네트워크를 통해서 xml 문서를 읽어오기
        new Thread(){
            @Override
            public void run() {
                //영화진흥위원회 open API 를 통해 일일박스오피스 정보를 가진 xml 문서를
                //읽어와서 분석하여 Listview 에 보여주기
                items.clear();
                ...
                //API28버전부터 http 경로에 대한 보안강화로 <application의 속성으로 android:usesCleartextTraffic="true" 추가 해야함
                //주소가 https 면 상관없음
                ...
                try {
                    ...
                    //읽어들인 XML 문서를 분석(parsing)해주는 객체 생성
