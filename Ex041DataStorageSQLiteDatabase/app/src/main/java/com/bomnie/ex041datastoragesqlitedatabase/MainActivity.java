package com.bomnie.ex041datastoragesqlitedatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    // 소규모 데이터를 관리하고 사용하는데 적합한 관계형 데이터베이스
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //만들어진 DB 파일에 "member"라는 이름으로 테이블 생성 작업 수행
    ...
    public void clickSelectAll(View view) {
        ...
        //Cursor 객체를 통해 결과 table 의 값들을 읽어옴
